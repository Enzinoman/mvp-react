...
INSERT INTO proposals (first_name, last_name, city, state_name, email, phone_number, community_name, proposal, reviewed, response, project_name, board_member) VALUES ('Alec', 'Baldwin', 'Columbus', 'Georgia', 'baldwin101@aol.com', '706-304-xxxx', 'Lanslide', 'Sidewalk improvement', 'false', '', '', ''),
('Mark', 'Merril', 'Colorado Springs', 'Colorado', 'MarkyMe@snailMail.com', '719-324-xxxx', 'Emeril', 'Weed barrier replacement in utility areas', 'true', 'Approved for action', 'WeedSmoker', 'Alec');
